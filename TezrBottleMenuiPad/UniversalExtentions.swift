...
extension CGPoint {
    ...
    static func +(lo: CGPoint, ro: CGFloat) -> CGPoint {
        return CGPoint(x: lo.x + ro, y: lo.y + ro)
    }
...
extension CGSize {
    static func +(lo: CGSize, ro: CGSize) -> CGSize {
        return CGSize(width: lo.width + ro.width, height: lo.height + ro.height)
    }
    ...
    static func +(lo: CGSize, ro: CGFloat) -> CGSize {
        return CGSize(width: lo.width + ro, height: lo.height + ro)
    }
...
public func roundf(_ float: CGFloat, interval: CGFloat) -> CGFloat {
    return CGFloat(Int(float / interval)) * interval
}
